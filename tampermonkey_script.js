...
(function() {
    ...
    const hotkeys = {
        'Shift+A': () => {
            console.log('Shift+A pressed - Archiving oldest conversation!');
            archiveOldestConversation();
        },
        'Shift+F': () => {
            console.log('Shift+F pressed - Pasting follow-up message!');
        ...
        'Shift+G': () => {
            console.log('Shift+G pressed - Pasting gospel message!');
